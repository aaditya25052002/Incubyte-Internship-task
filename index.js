...
rl.question('Please specify the initial direction (N, S, E, W, U, D): ', (initialDirection) => {
    rl.question('Please enter the commands (separated by commas, e.g., f,r,u,b,l): ', (input) => {
